...
export class HomePageService {
   players: Array<Player> = [ 
    ...
    {player_name:'Jorginho', team_name: 'Chelsea', player_type: 'Midfielder', image: "https://res.cloudinary.com/chelsea-production/image/upload/c_fill,dpr_auto,f_auto,fl_lossy,g_faces,h_410,q_auto,w_350,z_1.0/v1/editorial/people/first-team/2020-21/portrait/Jorginho_-_portrait_-_july20"},
    {player_name:'N Golo Kante', team_name: 'Chelsea', player_type: 'Midfielder', image: "https://res.cloudinary.com/chelsea-production/image/upload/c_fill,dpr_auto,f_auto,fl_lossy,g_face,h_410,q_auto,w_350,z_1.0/v1/editorial/people/first-team/2020-21/portrait/Kante_-_portrait_-_july20"},
    ...
    {player_name:'Bill Gilmour', team_name: 'Chelsea', player_type: 'Midfielder', image: "https://res.cloudinary.com/chelsea-production/image/upload/c_fill,dpr_auto,f_auto,fl_lossy,g_auto,h_410,q_auto,w_350,z_1.0/v1/editorial/people/first-team/2020-21/portrait/Gilmour_-_portrait_-_july20"},
